...
| `/DataBase/Files/Resend/FullReceipts/{FactoryID}` | Повторная отправка выбранных файлов типа FullReceipt из БД на сервер ОФД (по списку номеров чеков, не более 32). Опционально передача ответных файлов в ФМ |
...
| PaymentType | uint8 | Форма оплаты: 1 - Наличными, 2 - Безналичными, 3 - По QR-коду, 4 - Смешанная |
...
| RecipeID | string | Идентификатор рецепта (не более 32 символов, опционально) |
